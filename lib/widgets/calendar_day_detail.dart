...
///
/// Selecting a day is also how the rider changes it. A day that is still
/// ahead offers add, edit and remove; a completed one offers none of them,
/// because it is a record of a ride, not a plan to revise.
class CalendarDayDetail extends StatelessWidget {
  final CalendarEntry? entry;

  /// Schedule a workout on this empty day. Null hides the action.
  final VoidCallback? onAdd;

  /// Change the workout planned for this day.
  final VoidCallback? onEdit;

  /// Drop the workout planned for this day.
